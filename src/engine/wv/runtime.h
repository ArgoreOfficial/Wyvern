...
#include <wv/runtime/runtime_db.h>
...
template<> wv::IRuntimeQuery* wv::getRuntimeGlobal<_object>() { return wv::RuntimeDataBase::get()->m_queries[ #_object ]; } \
namespace _object##Query { \
template<typename _Ty> \
struct RuntimeQuery : public wv::IRuntimeQuery { \
	RuntimeQuery() : wv::IRuntimeQuery( #_object, #_base ) { \
		wv::RuntimeDataBase::get()->registerRuntime<_object>( (wv::IRuntimeQuery*)this ); \
	} }; }
