...
public:
	...
	void addDebugSphere( const wv::Vector3f& _centre, float _size ) {
		...
		m_debugLinePositions.push_back( vecs[  1 ] ); m_debugLinePositions.push_back( vecs[  3 ] );
		m_debugLinePositions.push_back( vecs[  1 ] ); m_debugLinePositions.push_back( vecs[  2 ] );
		m_debugLinePositions.push_back( vecs[  2 ] ); m_debugLinePositions.push_back( vecs[  4 ] );
		m_debugLinePositions.push_back( vecs[  3 ] ); m_debugLinePositions.push_back( vecs[  4 ] );
		m_debugLinePositions.push_back( vecs[  2 ] ); m_debugLinePositions.push_back( vecs[  5 ] );
		m_debugLinePositions.push_back( vecs[  5 ] ); m_debugLinePositions.push_back( vecs[  7 ] );
		m_debugLinePositions.push_back( vecs[  4 ] ); m_debugLinePositions.push_back( vecs[  7 ] );
		m_debugLinePositions.push_back( vecs[  3 ] ); m_debugLinePositions.push_back( vecs[ 18 ] );
		m_debugLinePositions.push_back( vecs[  4 ] ); m_debugLinePositions.push_back( vecs[ 19 ] );
		m_debugLinePositions.push_back( vecs[ 18 ] ); m_debugLinePositions.push_back( vecs[ 19 ] );
		m_debugLinePositions.push_back( vecs[  7 ] ); m_debugLinePositions.push_back( vecs[ 20 ] );
		m_debugLinePositions.push_back( vecs[ 19 ] ); m_debugLinePositions.push_back( vecs[ 20 ] );
		m_debugLinePositions.push_back( vecs[  5 ] ); m_debugLinePositions.push_back( vecs[  6 ] );
		m_debugLinePositions.push_back( vecs[  6 ] ); m_debugLinePositions.push_back( vecs[  8 ] );
		m_debugLinePositions.push_back( vecs[  7 ] ); m_debugLinePositions.push_back( vecs[  8 ] );
		m_debugLinePositions.push_back( vecs[  6 ] ); m_debugLinePositions.push_back( vecs[  9 ] );
		m_debugLinePositions.push_back( vecs[  9 ] ); m_debugLinePositions.push_back( vecs[ 11 ] );
		m_debugLinePositions.push_back( vecs[  8 ] ); m_debugLinePositions.push_back( vecs[ 11 ] );
		m_debugLinePositions.push_back( vecs[  8 ] ); m_debugLinePositions.push_back( vecs[ 23 ] );
		m_debugLinePositions.push_back( vecs[ 20 ] ); m_debugLinePositions.push_back( vecs[ 23 ] );
		m_debugLinePositions.push_back( vecs[ 11 ] ); m_debugLinePositions.push_back( vecs[ 26 ] );
		m_debugLinePositions.push_back( vecs[ 23 ] ); m_debugLinePositions.push_back( vecs[ 26 ] );
		m_debugLinePositions.push_back( vecs[  9 ] ); m_debugLinePositions.push_back( vecs[ 10 ] );
		m_debugLinePositions.push_back( vecs[ 10 ] ); m_debugLinePositions.push_back( vecs[ 12 ] );
		m_debugLinePositions.push_back( vecs[ 11 ] ); m_debugLinePositions.push_back( vecs[ 12 ] );
		m_debugLinePositions.push_back( vecs[ 10 ] ); m_debugLinePositions.push_back( vecs[ 13 ] );
		m_debugLinePositions.push_back( vecs[ 13 ] ); m_debugLinePositions.push_back( vecs[ 15 ] );
		m_debugLinePositions.push_back( vecs[ 12 ] ); m_debugLinePositions.push_back( vecs[ 15 ] );
		m_debugLinePositions.push_back( vecs[ 12 ] ); m_debugLinePositions.push_back( vecs[ 25 ] );
		m_debugLinePositions.push_back( vecs[ 25 ] ); m_debugLinePositions.push_back( vecs[ 26 ] );
		m_debugLinePositions.push_back( vecs[ 15 ] ); m_debugLinePositions.push_back( vecs[ 24 ] );
		m_debugLinePositions.push_back( vecs[ 24 ] ); m_debugLinePositions.push_back( vecs[ 25 ] );
		m_debugLinePositions.push_back( vecs[ 13 ] ); m_debugLinePositions.push_back( vecs[ 14 ] );
		m_debugLinePositions.push_back( vecs[ 14 ] ); m_debugLinePositions.push_back( vecs[ 16 ] );
		m_debugLinePositions.push_back( vecs[ 15 ] ); m_debugLinePositions.push_back( vecs[ 16 ] );
		m_debugLinePositions.push_back( vecs[  1 ] ); m_debugLinePositions.push_back( vecs[ 14 ] );
		m_debugLinePositions.push_back( vecs[  3 ] ); m_debugLinePositions.push_back( vecs[ 16 ] );
		m_debugLinePositions.push_back( vecs[ 16 ] ); m_debugLinePositions.push_back( vecs[ 21 ] );
		m_debugLinePositions.push_back( vecs[ 21 ] ); m_debugLinePositions.push_back( vecs[ 24 ] );
		m_debugLinePositions.push_back( vecs[ 18 ] ); m_debugLinePositions.push_back( vecs[ 21 ] );
		m_debugLinePositions.push_back( vecs[ 10 ] ); m_debugLinePositions.push_back( vecs[ 17 ] );
		m_debugLinePositions.push_back( vecs[ 14 ] ); m_debugLinePositions.push_back( vecs[ 17 ] );
		m_debugLinePositions.push_back( vecs[  6 ] ); m_debugLinePositions.push_back( vecs[ 17 ] );
		m_debugLinePositions.push_back( vecs[  2 ] ); m_debugLinePositions.push_back( vecs[ 17 ] );
		m_debugLinePositions.push_back( vecs[ 19 ] ); m_debugLinePositions.push_back( vecs[ 22 ] );
		m_debugLinePositions.push_back( vecs[ 21 ] ); m_debugLinePositions.push_back( vecs[ 22 ] );
		m_debugLinePositions.push_back( vecs[ 22 ] ); m_debugLinePositions.push_back( vecs[ 23 ] );
		m_debugLinePositions.push_back( vecs[ 22 ] ); m_debugLinePositions.push_back( vecs[ 25 ] );
	}
